...
def main() -> None:
    ...
    for kw, content in [
        (
            ["雪山列车"],
            "雪山号特快：1935 年制造，六节车厢，行驶于北境群山线。暴雪封路时列车会停在 13 号隧道前的临时避风线，无线电中断，与外界的唯一联系是每两小时一次的信号灯。",
        ),
        (
            ["毒杀"],
            "本案件死因为蓖麻毒素中毒，死亡时间约在午夜零时至一时之间。毒素溶于热红酒，摄入后 2-4 小时发作，症状类似急性肠胃炎，极易误判死亡时间——这是本案的关键时间诡计。",
        ),
        (
            ["密室"],
            "6 号包间：唯一的门自内反锁，车窗因暴雪结冰从内无法开启。但列车老式包间的通风口位于门框上方，宽度仅一掌，成年男子无法通过——密室是否成立，是本案核心。",
        ),
    ]:
        r = post(
            c,
