# ruff: noqa: E501
"""Core Runtime - Music 提示词常量（P1-1 从 api/v1/generations/music.py 抽离）。

含：写歌(_COMPOSE_PROMPT) / 圆桌单次(_ROUNDTABLE_PROMPT) / 讨论室人格(_DISCUSS_SYSTEM)
  / 选角(_CAST_PROMPT) / 批评提取(_FIX_LIST_PROMPT) / 定稿主编(_FINAL_PROMPT)
  / 对抗式任务构造器(_proposer/_critic/_defense/_supporter_task) / 发言者拼装(_speaker_prompt)。

纯文本常量；仅依赖 style._style_profile_block。
"""
from __future__ import annotations

from app.core.runtime.music.style import _style_profile_block
