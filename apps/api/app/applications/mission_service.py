...
from app.applications.text_utils import extract_json, result_text
...
async def plan_mission(db: AsyncSession, user_id: str, goal: str) -> list[dict[str, Any]]:
    ...
    from app.applications.profile_service import build_profile_text
...
async def _execute_music(
    ...
    from app.core.runtime.music.engine import MusicComposeRequest, compose_song
...
async def _execute_studio(db: AsyncSession, user_id: str, prompt: str) -> dict[str, Any]:
    ...
    from app.applications.creation_service import plan_project, setup_project
...
async def _execute_media_task(
    ...
    from app.applications.generation_service import create_media_task
...
async def _execute_search(db: AsyncSession, user_id: str, prompt: str) -> dict[str, Any]:
    from app.applications.knowledge_materials import _digest_web_results
    from app.applications.web_search import search_web
