...
from app.applications.group_service import create_group
from app.applications.provider_resolver import resolve_text_provider
from app.applications.sessions import create_chat as create_chat_row
from app.applications.text_utils import result_text as _result_text
...
async def _retrieve_theme_materials(
    ...
    from app.applications.knowledge_materials import retrieve_theme_materials
...
async def _retrieve_character_pool(
    ...
    无命中返回空列表——不阻塞。
    """
    from app.applications.knowledge_retrieval import retrieve
...
def _chat_transcript(chat: RoleplayChat) -> str:
    ...
    from app.applications import sessions as _sessions
...
async def publish_project(
    ...
    *,
    ...
    """
    from app.applications import sessions as _sessions
    from app.applications.story_forge import create_chapter, create_project
