...
from app.applications import roleplay
from app.applications.knowledge_retrieval import chunk_text, retrieve
...
from app.applications.worldbook import estimate_tokens, match_worldbook
...
async def generate_chapter(
    ...
    *,
    ...
    if draft_mode:
        from app.applications.story_gate import run_gated_generation
