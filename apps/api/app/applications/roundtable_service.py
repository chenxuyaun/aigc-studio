...
from app.applications.text_utils import sse_event as _sse_event
...
async def stream_roundtable(
    ...
    *,
    ...
    try:
        from app.applications.knowledge_materials import retrieve_creation_materials
        ...
        materials = ""
    from app.applications.knowledge_materials import format_material_block
